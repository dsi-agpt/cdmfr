...
class CourseType {
	 ...
	 * attribute codeSet.
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\CourseType\CourseCodeAType[] $courseCode
	 */
	 ...
	 * unit
	 *
	 * @property string[] $courseIntroduction
	 */
	...
	/**
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\TeachingTerm[] $teachingTerm
	 */
	...
	/**
	 *
	 * @property string[] $recommendedPrerequisites
	 */
	private $recommendedPrerequisites = null;
	
	/**
	 *
	 * @property string[] $formalPrerequisites
	 */
	...
	/**
	 *
	 * @property string[] $formOfTeaching
	 */
	private $formOfTeaching = null;
	
	/**
	 *
	 * @property string[] $formOfAssessment
	 */
	 ...
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\InfoBlockType[] $benefits
	 */
	 ...
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\InfoBlockType[] $overlap
	 */
	private $overlap = null;
	
	/**
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\Syllabus[] $syllabus
	 */
	 ...
	 * course
	 *
	 * @property \CdmFr\Model\V1_1_1\Cdm\CourseType\TeachingActivityAType[] $teachingActivity
	 */
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\CourseType\CourseCodeAType $courseCode        	
	 */
	public function addToCourseCode(\CdmFr\Model\V1_1_1\Cdm\CourseType\CourseCodeAType $courseCode) {
	 ...
	 * attribute codeSet.
	 *
	 * @return \CdmFr\Model\V1_1_1\Cdm\CourseType\CourseCodeAType[]
	 */
	 ...
	 */
	public function addToCourseIntroduction($courseIntroduction) {
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\TeachingTerm $teachingTerm        	
	 */
	public function addToTeachingTerm(\CdmFr\Model\V1_1_1\Cdm\TeachingTerm $teachingTerm) {
	 ...
	 *
	 * @return \CdmFr\Model\V1_1_1\Cdm\TeachingTerm[]
	 */
	 ...
	 */
	public function addToLearningObjectives($learningObjectives) {
	 ...
	 *
	 * @return self
	 * @param string $recommendedPrerequisites        	
	 */
	public function addToRecommendedPrerequisites(string $recommendedPrerequisites) {
	 ...
	 *
	 * @return self
	 * @param string $formalPrerequisites        	
	 */
	public function addToFormalPrerequisites(string $formalPrerequisites) {
	 ...
	 *
	 * @return self
	 * @param string $formOfTeaching        	
	 */
	public function addToFormOfTeaching($formOfTeaching) {
	 ...
	 *
	 * @return self
	 * @param string $formOfAssessment        	
	 */
	public function addToFormOfAssessment(string $formOfAssessment) {
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\InfoBlockType $benefits        	
	 */
	public function addToBenefits(\CdmFr\Model\V1_1_1\Cdm\InfoBlockType $benefits) {
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\InfoBlockType $overlap        	
	 */
	public function addToOverlap(\CdmFr\Model\V1_1_1\Cdm\InfoBlockType $overlap) {
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\Syllabus $syllabus        	
	 */
	public function addToSyllabus(\CdmFr\Model\V1_1_1\Cdm\Syllabus $syllabus) {
	 ...
	 * Gets as syllabus
	 *
	 * @return \CdmFr\Model\V1_1_1\Cdm\Syllabus[]
	 */
	 ...
	 *
	 * @return self
	 * @param \CdmFr\Model\V1_1_1\Cdm\CourseType\TeachingActivityAType $teachingActivity        	
	 */
	public function addToTeachingActivity(\CdmFr\Model\V1_1_1\Cdm\CourseType\TeachingActivityAType $teachingActivity) {
	 ...
	 * course
	 *
	 * @return \CdmFr\Model\V1_1_1\Cdm\CourseType\TeachingActivityAType[]
	 */
