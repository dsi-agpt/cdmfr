...
class ExamType
{
     ...
     * Name of the exam
     *
     * @property \CdmFr\Model\V1_1_1\CdmFr\TextType\TextAType[] $examName
     */
    private $examName = null;

    /**
     * Type of assessment: e.g. oral examination,
     *  written
     *  examination, oral presentation, test, paper, portfolio,
     *  thesis, report about
     *  an internship, report on fieldwork, continuous
     *  assessment. Kind of exam:
     *  e.g. ordinary, extraordinary examination.
     *
     * @property \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamKindAType $examKind
     */
     ...
     *
     * @property \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamDurationAType $examDuration
     */
     ...
     * Exam part structure
     *
     * @property \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamStructureAType $examStructure
     */
     ...
     */
    public function addToExamName(\CdmFr\Model\V1_1_1\CdmFr\TextType\TextAType $text)
    {
        $this->examName[] = $text;
        return $this;
    }
     ...
     * Name of the exam
     *
     * @param \CdmFr\Model\V1_1_1\CdmFr\TextType\TextAType[] $examName
     * @return self
     */
     ...
     *  e.g. ordinary, extraordinary examination.
     *
     * @return \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamKindAType
     */
     ...
     *  e.g. ordinary, extraordinary examination.
     *
     * @param \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamKindAType $examKind
     * @return self
     */
    public function setExamKind(\CdmFr\Model\V1_1_1\Cdm\ExamType\ExamKindAType $examKind)
    {
     ...
     * Duration of the exam.
     *
     * @return \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamDurationAType
     */
     ...
     * Duration of the exam.
     *
     * @param \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamDurationAType $examDuration
     * @return self
     */
    public function setExamDuration(\CdmFr\Model\V1_1_1\Cdm\ExamType\ExamDurationAType $examDuration)
    {
     ...
     * Exam part structure
     *
     * @return \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamStructureAType
     */
     ...
     * Exam part structure
     *
     * @param \CdmFr\Model\V1_1_1\Cdm\ExamType\ExamStructureAType $examStructure
     * @return self
     */
    public function setExamStructure(\CdmFr\Model\V1_1_1\Cdm\ExamType\ExamStructureAType $examStructure)
    {
