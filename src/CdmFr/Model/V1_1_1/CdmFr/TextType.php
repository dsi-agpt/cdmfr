...
class TextType
{
    ...
    /**
     * The information of this text expressed in a given languages
     *
     * @property \CdmFr\Model\V1_1_1\CdmFr\TextType\TextAType[] $text
     */
    private $text = null;
     ...
     */
    public function addToText(\CdmFr\Model\V1_1_1\CdmFr\TextType\TextAType $text)
    {
        $this->text[] = $text;
        return $this;
    }
